...
- [ ] **Phase 3 — RAG**: embed labeled emails into a vector store, retrieve k nearest as dynamic few-shot examples, measure lift against the Phase 2 baseline (`docs/RAG.md`, branch `feature/phase-3-rag`; leave-one-out live eval **0.982** vs Phase 2 **0.972** — awaiting merge approval).
