...
- [ ] **Phase 2 — Evals**: hand-labeled golden set, eval harness reporting per-label precision/recall, LLM-routing rate, cost and latency, plus structured logging and tracing.
